...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
      ...
      <header className="relative z-10 p-4 sm:p-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-2 sm:space-x-3">
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-pink-500 to-violet-600 rounded-xl flex items-center justify-center shadow-lg">
          ...
          <Button
            ...
            variant="outline"
            size="sm"
            className="border-slate-600 text-slate-300 hover:bg-slate-800/50 backdrop-blur-sm text-xs sm:text-sm px-3 sm:px-4"
          >
      ...
      <main className="relative z-10 px-4 sm:px-6 py-8 sm:py-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-8 sm:mb-16">
            <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-pink-500/10 to-violet-600/10 border border-pink-500/20 rounded-full px-3 sm:px-4 py-2 mb-6 sm:mb-8">
              <Sparkles className="w-3 h-3 sm:w-4 sm:h-4 text-pink-400" />
              <span className="text-pink-300 text-xs sm:text-sm font-medium">
            ...
            <p className="text-base sm:text-xl text-slate-400 mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed px-4">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-4 px-4">
              <Button
                ...
                size="lg"
                className="w-full sm:w-auto bg-gradient-to-r from-pink-500 to-violet-600 hover:from-pink-600 hover:to-violet-700 text-white font-medium px-6 sm:px-8 py-3 shadow-lg hover:shadow-xl transition-all duration-200"
              >
              ...
              <Button
                variant="outline"
                size="lg"
                className="w-full sm:w-auto border-slate-600 text-slate-300 hover:bg-slate-800/50 backdrop-blur-sm px-6 sm:px-8 py-3"
              >
          ...
          {/* Features Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-16 px-4">
            ...
            <Card className="bg-slate-800/50 border-slate-700/50 backdrop-blur-sm hover:bg-slate-800/70 transition-all duration-300 sm:col-span-2 lg:col-span-1">
              <CardContent className="p-4 sm:p-6 text-center">
          ...
          {/* Statistics */}
          <div className="bg-gradient-to-r from-slate-800/50 to-slate-700/50 border border-slate-600/50 backdrop-blur-sm rounded-2xl p-4 sm:p-6 lg:p-8 mb-8 sm:mb-16 mx-4">
      ...
      {/* Footer */}
      <footer className="relative z-10 border-t border-slate-700/50 bg-slate-900/50 backdrop-blur-sm mt-8 sm:mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2 sm:space-x-3">
              <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-br from-pink-500 to-violet-600 rounded-lg flex items-center justify-center">
                <Film className="w-3 h-3 sm:w-4 sm:h-4 text-white" />
              </div>
